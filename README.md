...
- You can mark the days for visiting orphanages;
   ...
   - Schedule visits,
   - Get in touch via Whatsapp 📞 or site,
...
<h2 align="center">Challenges along the way 🤯</h2>

   <p>
      Next Level Week, as many people know, is not a joke, it requires practice, intensity and above all, a lot of focus!<br>
      Fortunately, I'm doing well and we must always be looking for the next level and get better every day!<br>
...
<h2 align="center">How to Use 🤔</h2>
   ...
   $ git clone https://github.com/Lincoln-Silva/Happy-NLW3 Happy
